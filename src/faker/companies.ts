...
const companies = new Array(20).fill(null).map(() => ({
  ...
  image: f.image.imageUrl(320, 180),
  images: [
    f.image.imageUrl(320, 180),
    f.image.imageUrl(640, 360),
    f.image.imageUrl(960, 540),
    f.image.imageUrl(1280, 720),
    f.image.imageUrl(1600, 900),
  ],
  address: {
